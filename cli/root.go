// Package cli builds the sinanews command tree on top of the sinanews library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: sinanews.DefaultConfig()}
...
func (a *App) setup() error {
	...
	a.client = sinanews.NewClient(a.cfg)
	return nil
}
